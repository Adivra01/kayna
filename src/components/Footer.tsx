...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary pt-16 sm:pt-20 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 pb-12 sm:pb-16 border-b border-secondary/10">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-secondary font-bold mb-3 sm:mb-4 text-sm sm:text-base">Shop</h3>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-secondary font-bold mb-3 sm:mb-4 text-sm sm:text-base">Infos</h3>
            <ul className="space-y-2 sm:space-y-3 text-sm">
          ...
          {/* Newsletter */}
          <div className="col-span-2 lg:col-span-4">
            <h3 className="text-secondary font-bold mb-3 sm:mb-4 text-sm sm:text-base">Newsletter</h3>
            <p className="text-secondary/60 mb-3 sm:mb-4 text-sm">
              Rejoins la communauté. Nouveautés et offres exclusives.
            </p>
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <div className="relative flex-1">
                  <Mail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-secondary/40" />
                  <input
                    type="email"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    placeholder="Ton email"
                    className="w-full pl-10 sm:pl-11 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-secondary/5 border border-secondary/20 rounded-full text-secondary text-sm placeholder:text-secondary/40 focus:outline-none focus:border-accent transition-colors"
                    required
                  />
                </div>
