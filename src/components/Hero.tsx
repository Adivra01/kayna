...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen overflow-hidden bg-primary">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-12 py-4 sm:py-6 flex items-center justify-between backdrop-blur-md bg-primary/80 border-b border-secondary/30">
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-6 text-sm text-white/90">
            ...
            <a href="/about" className="relative hover:text-secondary transition-colors group">
              Notre Histoire
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <a href="https://x.com/kayna20xxv?s=11" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-accent hover:text-primary hover:border-accent transition-all hover:scale-110 hover:shadow-energy-glow">
              <SiX className="w-3 h-3 sm:w-4 sm:h-4" />
            </a>
            <a href="https://www.threads.com/@kayna.xxv?invite=0" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-secondary hover:text-primary hover:border-secondary transition-all hover:scale-110 hover:shadow-earth-glow">
      ...
      <div className="min-h-screen flex flex-col lg:flex-row pt-16 sm:pt-20">
        ...
        <div className="lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-16 py-8 sm:py-12 lg:py-0 relative">
          {/* Ambient glow effects - Orange + Beige fusion */}
          <div className="absolute top-1/4 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-accent/20 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-1/3 right-1/4 w-48 sm:w-80 h-48 sm:h-80 bg-secondary/20 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
          ...
          <div className="max-w-2xl relative z-10 w-full">
            <div ref={headingRef} className="space-y-4 sm:space-y-6 lg:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4">
                <button className="group relative px-6 sm:px-8 lg:px-10 py-3.5 sm:py-4 lg:py-5 bg-accent text-primary rounded-full font-bold text-base sm:text-lg overflow-hidden shadow-energy hover:shadow-energy-glow transition-all hover:scale-105">
                ...
                <a href="/about" className="px-6 sm:px-8 lg:px-10 py-3.5 sm:py-4 lg:py-5 border-2 border-secondary text-white rounded-full font-bold text-base sm:text-lg hover:bg-secondary hover:text-primary transition-all flex items-center justify-center gap-2 sm:gap-3 group hover:scale-105">
        ...
        <div ref={imageRef} className="lg:w-1/2 relative min-h-[50vh] sm:min-h-[60vh] lg:min-h-screen">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-br from-primary/85 via-secondary/40 to-accent/20" />
            
            {/* Floating Elements - Orange/Beige accents */}
            <div className="absolute top-6 sm:top-12 right-4 sm:right-12 backdrop-blur-md bg-primary/70 border border-secondary/50 px-3 sm:px-6 py-2 sm:py-4 rounded-xl sm:rounded-2xl shadow-earth animate-float">
            ...
            <div className="absolute bottom-6 sm:bottom-12 left-4 sm:left-12 bg-accent text-primary px-4 sm:px-8 py-3 sm:py-6 rounded-2xl sm:rounded-3xl shadow-energy-glow hover:scale-105 transition-all cursor-pointer group">
            ...
            <div className="hidden sm:block absolute top-1/2 left-6 lg:left-12 -translate-y-1/2 animate-float">
              <div className="w-16 lg:w-20 h-16 lg:h-20 rounded-full border-2 lg:border-3 border-secondary flex items-center justify-center backdrop-blur-md bg-primary/50 cursor-pointer hover:scale-110 transition-all group shadow-earth hover:shadow-earth-glow">
                <ArrowDown className="w-6 lg:w-8 h-6 lg:h-8 text-secondary group-hover:animate-bounce" />
              </div>
            </div>
            
            {/* Decorative rotating element - Beige accent */}
            <div className="hidden sm:block absolute top-1/4 right-1/4 w-24 sm:w-32 h-24 sm:h-32 border border-secondary/40 rounded-full animate-rotate-slow"></div>
          </div>
        </div>
      </div>
    </section>
