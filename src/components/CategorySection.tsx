    ...
    <section ref={sectionRef} className="py-24 lg:py-32 bg-primary relative">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <div className="inline-flex items-center gap-3 px-5 py-2 bg-accent/15 border border-accent/40 rounded-full mb-8">
          ...
          <h2 className="text-display font-bold leading-none mb-6 text-white">
            Trouve ton
            <span className="block italic text-secondary">style</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          {categories.map((category, index) => (
            ...
            >
              <div className="relative bg-primary-light border border-accent/30 rounded-3xl p-8 lg:p-10 hover:bg-gradient-to-br hover:from-secondary hover:to-secondary-light hover:text-white hover:border-secondary transition-all duration-500 hover:scale-105 hover:shadow-blood-glow overflow-hidden">
                {/* Background Number */}
        ...
        <div ref={imageRef} className="mt-20 relative max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-[3rem] overflow-hidden aspect-[4/5] group border border-accent/30 shadow-void-lg">
              <img 
                src={hoodie1} 
                alt="Collection KAYNA" 
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/85 via-secondary/20 to-transparent" />
            ...
            <div className="space-y-8">
              ...
              <button className="px-8 py-4 bg-secondary text-white rounded-full font-bold hover:bg-secondary-light transition-all hover:scale-105 shadow-blood hover:shadow-blood-glow flex items-center gap-3 group">
                <span>Découvrir</span>
