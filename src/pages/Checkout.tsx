...
const Checkout = () => {
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      // Create order in database - order_number is auto-generated by trigger
      const { data: order, error: orderError } = await supabase
        .from("orders")
        .insert({
          order_number: "", // Will be auto-generated by trigger set_order_number
          user_id: user?.id || null, // Link to user if authenticated, null for guest
          customer_name: `${customerInfo.firstName} ${customerInfo.lastName}`,
          email: customerInfo.email,
          phone: customerInfo.phone,
          shipping_address_1: customerInfo.address1,
          shipping_address_2: customerInfo.address2 || null,
