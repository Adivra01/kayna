...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    product: {
      ...
      freeShipping: "Livraison incluse dans le prix",
  ...
  en: {
    ...
    product: {
      ...
      freeShipping: "Shipping included in price",
  ...
  es: {
    ...
    product: {
      ...
      freeShipping: "Envío incluido en el precio",
  ...
  ar: {
    ...
    product: {
      ...
      freeShipping: "الشحن مشمول في السعر",
  ...
  pt: {
    ...
    product: {
      ...
      freeShipping: "Frete incluído no preço",
    ...
    cart: {
      ...
      shippingIncluded: "Frete incluído",
      expiresIn: "Expira em",
      item: "item",
      items: "itens",
    },
