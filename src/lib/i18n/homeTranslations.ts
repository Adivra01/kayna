...
export const homeTranslations: Record<Language, HomeTranslations> = {
  fr: {
    ...
    promiseShipping: "Livraison offerte dès 75€",
    promiseReturns: "Retours gratuits 30j",
  ...
  en: {
    ...
    promiseShipping: "Free shipping over $75",
    promiseReturns: "Free returns 30 days",
  ...
  es: {
    ...
    promiseShipping: "Envío gratis desde 75€",
    promiseReturns: "Devoluciones gratis 30 días",
  ...
  ar: {
    ...
    promiseShipping: "شحن مجاني فوق 75$",
    promiseReturns: "إرجاع مجاني 30 يوم",
  ...
  pt: {
    ...
    promiseShipping: "Frete grátis acima de 75€",
    promiseReturns: "Devoluções grátis 30 dias",
